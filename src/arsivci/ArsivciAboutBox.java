...
public class ArsivciAboutBox extends javax.swing.JDialog {

    public ArsivciAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(arsivci.ArsivciApp.class).getContext().getResourceMap(ArsivciAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(arsivci.ArsivciApp.class).getContext().getActionMap(ArsivciAboutBox.class, this);
